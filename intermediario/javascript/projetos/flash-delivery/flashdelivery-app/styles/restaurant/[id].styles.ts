...
const styles = StyleSheet.create({
  ...
  logoWrap: { position: 'absolute', bottom: -28, left: 16, width: 64, height: 64, borderRadius: 999, backgroundColor: '#ffffff', borderWidth: 2, borderColor: '#ffffff', overflow: 'hidden', elevation: 2 },
  ...
  separator: { height: 12 },
  tabsRow: { flexDirection: 'row', gap: 8, marginTop: 8 },
  tab: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999, borderWidth: 1, borderColor: '#e9ecef', backgroundColor: '#ffffff' },
  tabActive: { backgroundColor: '#0d6efd', borderColor: '#0d6efd' },
  tabText: { color: '#0b2135', fontWeight: '700' },
